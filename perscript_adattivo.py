...
if __name__ == "__main__":
    df = creazione_df(
        10000, 20, 15, np.array([0.01, 0.1]), 0.98
    )  # cambiare ultimo valore se si vuole cambiare proporzione flat
    # df = pd.read_csv(r"dati_generati/dati_generati_17_dim_2perc.csv")
